...
- DDL_ENTRY_INDEX_START_NUMBER: create table是创建一条，对应的ddl_manager更新，在重启的时候ddlmanger也会读取该信息更新，在该INDEX中存了每个Table的CF与Index的对于关系（table-defination -> key_definations）
